...
public class GoogleNowExpandCard extends CardExpand {
    ...
    public void setupInnerViewElements(ViewGroup parent, View view) {
        ...
        TextView tx1 = (TextView) view.findViewById(R.id.carddemo_extras_expand_text1);
        TextView tx2 = (TextView) view.findViewById(R.id.carddemo_extras_expand_text2);
        TextView tx3 = (TextView) view.findViewById(R.id.carddemo_extras_expand_text3);
        TextView tx4 = (TextView) view.findViewById(R.id.carddemo_extras_expand_text4);
