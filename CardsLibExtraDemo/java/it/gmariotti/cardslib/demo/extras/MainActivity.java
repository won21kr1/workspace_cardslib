...
public class MainActivity extends Activity {
    ...
    private static final int CASE_CALL_ACTIVITY= 11;
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
                                long id) {
    				if (position == CASE_CALL_ACTIVITY) {
    			
        	    Intent intent = new Intent(mSaveContext, com.example.android.displayingbitmaps.ui.ImageGridActivity.class);
    ...
    private void openFragment(BaseFragment baseFragment, String arg_kind) {
    	Log.i("MainActivity ", "OpenFlagment : " + arg_kind);
    	
    	if (baseFragment == null) return;
    	
    	if (Build.VERSION.SDK_INT < 19 && arg_kind.equals("3")) return;
